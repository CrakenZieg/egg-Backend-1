...
public class Hotel5 extends Hotel4{
    ...
    private int cantSalones, cantSuite, cantLimo;

    public Hotel5(int cantSalones, int cantSuite, int cantLimo, Gimnasio gimnasio, Restaurante restaurante, int cantHabitaciones, int numCamas, int cantPisos, String nombre, String direccion, String localidad, String gerente) {
        super(gimnasio, restaurante, cantHabitaciones, numCamas, cantPisos, nombre, direccion, localidad, gerente);
        this.cantSalones = cantSalones;
        this.cantSuite = cantSuite;
        this.cantLimo = cantLimo;
        this.precioHabitacion+=cantLimo*15;
    }
    ...
    public String toString() {
        ...
        sb.append(" salones: ").append(cantSalones);
        sb.append(", suites: ").append(cantSuite);
        sb.append(", limosinas: ").append(cantLimo);
        return sb.toString();
    }
