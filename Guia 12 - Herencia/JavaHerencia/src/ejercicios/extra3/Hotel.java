...
public class Hotel extends Alojamiento implements Comparable<Hotel>{
    ...
    protected Hotel(int cantHabitaciones, int numCamas, int cantPisos, String nombre, String direccion, String localidad, String gerente) {
    ...
    public String toString() {
        ...
        sb.append(", camas: ").append(numCamas);
        sb.append(", pisos: ").append(cantPisos);
        sb.append(", precio por habitacion: $").append(precioHabitacion);
        return sb.toString();
    }    

    @Override
    public int compareTo(Hotel hotel) {
        return Double.compare(hotel.precioHabitacion, this.precioHabitacion);
