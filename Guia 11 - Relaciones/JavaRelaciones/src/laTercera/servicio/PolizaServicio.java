...
import laTercera.entidades.Poliza;
...
public class PolizaServicio {
    ...
    public Vehiculo crearPoliza(Cliente cliente, Vehiculo vehiculo) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public Poliza elimarPoliza(Poliza poliza) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public Poliza actualizaPoliza(Poliza poliza) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public int encontrarPoliza(int numPoliza) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
}
/*
