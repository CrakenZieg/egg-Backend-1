...
public class Pelicula {
    ...
    public Pelicula(String titulo, String director, double duracion, int edadMin) {
        ...
        int minutos = (int)((duracion%1)*60);
        duracionS = Integer.toString(horas)+":"+Integer.toString(minutos)+" horas";
    }
    ...
    public String toString() {
        return titulo + ", de " + director + ", " + duracionS + " de duracion, edadMin=" + edadMin + ".";
    }
