...
public class Hotel4 extends Hotel{
    ...
    public Hotel4(Gimnasio gimnasio, Restaurante restaurante, int cantHabitaciones, int numCamas, 
            int cantPisos, String nombre, String direccion, String localidad, String gerente) {
        super(cantHabitaciones, numCamas, cantPisos, nombre, direccion, localidad, gerente);
        this.gimnasio = gimnasio;
        this.restaurante = restaurante;
        this.precioHabitacion = 50+numCamas+restaurante.getPrecio()+gimnasio.getValor();
    }
    ...
    public String toString() {
        ...
        sb.append(", gimansio: ").append(gimnasio);
