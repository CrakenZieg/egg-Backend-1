...
public class Restaurante {
    ...
    public Restaurante(String nombre, int capacidad) {
        ...
        if(capacidad>50){
            this.modulo=Modulo.GRANDE;
        } else if(capacidad>=30){
            this.modulo=Modulo.MEDIANO;
        } else {
            this.modulo=Modulo.PEQUENO;
        }
    }
    ...
    public int getPrecio(){
        return this.modulo.getModificador();
    }
    ...
    public String toString() {
        ...
        sb.append(", tamaño: ").append(modulo);
        return sb.toString();
    }
}
/*
