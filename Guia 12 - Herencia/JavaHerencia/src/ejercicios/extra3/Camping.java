...
public class Camping extends AlojamientoExtraHotelero{
    ...
    private int carpas, banos;
    private boolean restaurante;

    public Camping(int carpas, int bnos, boolean restaurante, boolean publico, double superficie, String nombre, String direccion, String localidad, String gerente) {
    ...
    public void setBanos(int baños) {
        this.banos = baños;
    }
    ...
    public String toString() {
        ...
        sb.append(" carpas: ").append(carpas);
        sb.append(", baños: ").append(banos);
        sb.append(", "+(restaurante?" con resturante ":" sin restaurante "));
        return sb.toString();
    }
